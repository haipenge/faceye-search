	...
	<div class="col-md-10 col-md-offset-1 bg-white">
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="content">
					<a href="<c:url value="/search/movie/view/${movie.id}.html"/>"
						title="${movie.name}<fmt:message key="search.movie.online.show"/>" class="btn btn-lg btn-success"><fmt:message
							key="search.movie.online.show" /></a> <a href="<c:url value="/search/movie/download/${movie.id}.html"/>"
						title="${movie.name}<fmt:message key="search.movie.xunlie.download"/>" class="btn btn-lg btn-info"><fmt:message
							key="search.movie.xunlei.download" /></a>
				</div>
				<div class="content">
					<a href="#" title="${movie.name}<fmt:message key="search.movie.mobile"/>">${movie.name}<fmt:message
							key="search.movie.mobile" /></a>| <a href="#" title="${movie.name}<fmt:message key="search.movie.pad"/>">${movie.name}<fmt:message
