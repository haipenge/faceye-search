...
<link rel="stylesheet" type="text/css"
	href="<c:url value="/js/component/search/article/article.css"/>" />
...
<div class="panel panel-primary">
	<div class="panel-heading">
		<div class="panel-title">
			...
			<a class="btn btn-success btn-sm pull-right" href="<c:url value="/search/article/input"/>">
			  <fmt:message key="search.article.add"></fmt:message>
			</a>
		</div>
	</div>
	<div class="panel-body">
	    <div class="content">
	      	<form action="<c:url value="/search/article/home"/>" method="post" role="form" class="form-horizontal">
 ...
 <!--@generate-entity-jsp-property-value@-->
						<td>
						   <a href="<c:url value="/search/article/edit/${article.id}"/>">
						     <fmt:message key="global.edit"></fmt:message>
						   </a>
						 </td>
						<td>
						   <a href="<c:url value="/search/article/remove/${article.id}"/>">
