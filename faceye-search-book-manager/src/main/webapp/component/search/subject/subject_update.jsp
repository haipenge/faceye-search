...
<div class="panel panel-primary">
	<div class="panel-heading">
		<div class="panel-title">
			<fmt:message key="search.subject.edit"></fmt:message>
		</div>
	</div>
	<div class="panel-body">
		<form action="<c:url value="/search/subject/save"/>" method="post" role="form" class="form-horizontal">
			...
			<fieldset>
					...
					<div class="col-md-4">
						<input type="text" name="name" value="${subject.name}" class="form-control">
                				...
                				<div class="form-group">
					<label class="col-md-4 control-label" for="alias">
					  <fmt:message key="search.subject.alias"></fmt:message>
					</label>
					<div class="col-md-4">
						<input type="text" name="alias" value="${subject.alias}" class="form-control">
					</div>
				</div>
