...
<link rel="stylesheet" type="text/css"
	href="<c:url value="/css/component/index/analyzerWord/analyzerWord.css"/>" />
...
<div class="panel panel-primary">
	<div class="panel-heading">
		<div class="panel-title">
			...
			<a class="btn btn-success btn-sm pull-right" href="<c:url value="/index/analyzerWord/input"/>">
			  <fmt:message key="index.analyzerWord.add"></fmt:message>
			</a>
		</div>
	</div>
	<div class="panel-body">
	    <div class="content">
	      	<form action="<c:url value="/index/analyzerWord/home"/>" method="post" role="form" class="form-horizontal">
 ...
 <!--@generate-entity-jsp-property-value@-->
						<td>
						   <a href="<c:url value="/index/analyzerWord/edit/${analyzerWord.id}"/>">
						     <fmt:message key="global.edit"></fmt:message>
						   </a>
						 </td>
						<td>
						   <a href="<c:url value="/index/analyzerWord/remove/${analyzerWord.id}"/>">
