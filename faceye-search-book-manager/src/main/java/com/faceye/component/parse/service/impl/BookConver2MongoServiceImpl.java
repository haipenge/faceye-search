...
public class BookConver2MongoServiceImpl implements MySQL2MongoService {
	...
	private void converCategory(){
		CategoryService categoryService=BeanContextUtil.getBean(CategoryService.class);
		List<Category> allCategories=categoryService.getAll();
	    logger.debug(">>FaceYe --> conver category 2 mongo now.");
		com.faceye.component.book.service.CategoryService mCategoryService=BeanContextUtil.getBean(com.faceye.component.book.service.CategoryService.class);
	...
	private void converBook(){
		...
		BookService bookService=BeanContextUtil.getBean(BookService.class);
		List<Book> allBooks=bookService.getAll();
		if(CollectionUtils.isNotEmpty(allBooks)){
			com.faceye.component.book.service.BookService mBookService =BeanContextUtil.getBean(com.faceye.component.book.service.BookService.class);
	...
	private void converSection(){
		...
		SectionService sectionService=BeanContextUtil.getBean(SectionService.class);
		com.faceye.component.book.service.SectionService mSectionService =BeanContextUtil.getBean(com.faceye.component.book.service.SectionService.class);
		int page=1,size=500;
