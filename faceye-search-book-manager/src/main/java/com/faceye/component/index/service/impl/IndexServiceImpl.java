 ...
 * 索引服务类
 * 
 * @author @haipenge haipenge@gmail.com Create Date:2014年7月13日
 */
@Service
public class IndexServiceImpl implements IndexService {
	...
	public void buildIndex() {
		...
		try {
			...
			while (isContinue) {
				page++;
				Page<Article> searchArticles = this.searchArticleService.getPage(searchParams, page, 100);
				...
				// Page<ParseResult> parseResults =
				// this.parseResultService.getPage(searchParams, 1, 100);
	...
	private Document buildDocument(Long id, String name, String content, Date createDate) {
		...
		Field fieldDate = new StringField("createDate", DateUtils.formatDate(createDate, "yyyy-MM-dd HH:mm:ss"),
				Field.Store.YES);
		doc.add(fieldDate);
		return doc;
	}
	 ...
	 * @todo
	 * @param content
	 * @author:@haipenge haipenge@gmail.com 2014年10月2日
	 */
