...
<div class="panel panel-primary">
	...
	<div class="panel-body">
			<fieldset>
				...
				<tr>
	<td><fmt:message key="spider.matcherConfig.isWeixin"></fmt:message></td>
	<td>${matcherConfig.isWeixin}</td>
</tr>
<tr>
	<td><fmt:message key="spider.matcherConfig.categoryName"></fmt:message></td>
	<td>${matcherConfig.categoryName}</td>
</tr>
<tr>
	<td><fmt:message key="spider.matcherConfig.categoryAlias"></fmt:message></td>
