	...
	<div class="content">
		<form action="<c:url value="/spider/matcherConfig/save"/>" method="post" role="form" class="form-horizontal">
			...
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<select name="siteId" class="form-control">
							<option><fmt:message key="spider.site.select"/></option>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<select name="type" class="form-control">
							<option><fmt:message key="spider.link.type" /></option>
							<option value="1" <c:if test="${matcherConfig.type eq 0 }">selected</c:if>><fmt:message key="spider.link.type.0" /></option>
							<option value="1" <c:if test="${matcherConfig.type eq 1 }">selected</c:if>><fmt:message key="spider.link.type.1" /></option>
							<option value="2" <c:if test="${matcherConfig.type eq 2 }">selected</c:if>><fmt:message key="spider.link.type.2" /></option>
						</select>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-md-2 control-label" for="titleRegexp"> <fmt:message key="spider.matcherConfig.titleRegexp"></fmt:message>
					</label>
					<div class="col-md-8">
				...
				<div class="form-group">
					<label class="col-md-2 control-label" for="typeOfLinkAfterParse"> <fmt:message key="spider.matcherConfig.typeOfLinkAfterParse"></fmt:message>
					</label>
					<div class="col-md-8">
						<select name="typeOfLinkAfterParse" class="form-control">
							<option><fmt:message key="spider.link.type" /></option>
							<option value="0" <c:if test="${matcherConfig.typeOfLinkAfterParse eq 0 }">selected</c:if>><fmt:message key="spider.link.type.0" /></option>
							<option value="1" <c:if test="${matcherConfig.typeOfLinkAfterParse eq 1 }">selected</c:if>><fmt:message key="spider.link.type.1" /></option>
							<option value="2" <c:if test="${matcherConfig.typeOfLinkAfterParse eq 2 }">selected</c:if>><fmt:message key="spider.link.type.2" /></option>
						</select>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-2 control-label" for="categoryName"> <fmt:message key="spider.matcherConfig.categoryName"></fmt:message>
					</label>
					<div class="col-md-8">
						<input type="text" name="categoryName" value="${matcherConfig.categoryName}" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-2 control-label" for="categoryAlias"> <fmt:message key="spider.matcherConfig.categoryAlias"></fmt:message>
					</label>
					<div class="col-md-8">
						<input type="text" name="categoryAlias" value="${matcherConfig.categoryAlias}" class="form-control">
					</div>
				</div>
