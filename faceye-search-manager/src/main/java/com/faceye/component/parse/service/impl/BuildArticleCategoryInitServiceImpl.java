						...
						if(StringUtils.contains(keywords, ",")){
							...
							for(String k:keyword){
								if(StringUtils.isNotEmpty(k)){
									if(StringUtils.contains(name.toLowerCase(), k.toLowerCase())|| StringUtils.contains(content.toLowerCase(), k.toLowerCase())){
										category=a;
									}
								}
							}
						}else{
							if(StringUtils.contains(name.toLowerCase(), keywords.toLowerCase())|| StringUtils.contains(content.toLowerCase(), keywords.toLowerCase())){
								category=a;
							}
						}
					}
