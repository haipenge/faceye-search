...
<div class="row">
	<div class="col-md-10 col-md-offset-1 bg-white">
			...
			<div class="col-md-6">
				...
				<div class="row">
					<div class="content">
						<a href="<c:url value="/search/movie/detail/${movie.id}.html"/>"
							title="${movie.name}<fmt:message key="search.movie.xunlei.download"/>" class="btn btn-lg btn-success"><fmt:message
				...
				<div class="content">
					...
					<a href="<c:url value="/search/movie/download/${movie.id}.html"/>"
						title="${movie.name}<fmt:message key="search.movie.xunlie.download"/>"><fmt:message
							key="search.movie.xunlei.download" /></a>
				</div>
				<div class="content">
		...
		<div class="row">
			...
			<div class="content col-md-offset-4">${movie.description }</div>
		</div>
	</div>
